            ...
            <div>
                ...
                @if(!auth()->user()->getStripeHelper()->isExpressUser())
                    <div class="list-group">
                        <a class="list-group-item list-group-item-action flex-column align-items-start text-center pulse" href="{{ env('STRIPE_CONNECT_URL') }}">
                            ...
                            <p><button type="button" class="btn btn-primary btn-block mt-2 ladda-button"
                                    onclick="window.location.href = '{{ env('STRIPE_CONNECT_URL') }}';"
