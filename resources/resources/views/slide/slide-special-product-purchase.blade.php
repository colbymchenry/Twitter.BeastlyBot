    ...
    <div class="row">
        ...
        <div class="col-sm-2 col-4">
            <a class="avatar avatar-xxl" href="javascript:void(0)">
                <img id="discord_icon"
                     src="{{ auth()->user()->getTwitterHelper()->getAvatar() }}"
                     alt="...">
            </a>
        </div>
        <div class="col-sm-8 col-8">
            <h1 class="pt-10 pl-10" id="discord_username" style="color: white;">{{ auth()->user()->getTwitterHelper()->getUsername() }}</h1>
        ...
        <div class="pt-0 pt-md-25 pt-lg-25 pt-xl-50">
            ...
            <div class="w-300 mt-30 mx-auto">
                <div class="container">
                    <div class="row">
                        <br/>
                        @if((auth()->user()->getTwitterHelper()->ownsGuild($guild_id)) && (!auth()->user()->canAcceptPayments()))
