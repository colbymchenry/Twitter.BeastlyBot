...
@section('metadata')
<meta name="description" content="The beastly subscription bot for Twitter, monetize your followers & earn from your feed.">
<meta name="keywords" content="BeastlyBot, Beastly Bot, Twitter, Subscription, Payments, Folllowers">
                ...
                <div class="col-lg-6 col-md-6 order-1 order-md-2">
                    ...
                    <div class="banner-caption pt-50 pt-sm-none">
                        ...
                        <div class="wow fadeInUp" data-wow-delay=".2s" style="visibility:hidden">
                            <p class="mb-20">The beastly subscription bot for Twitter,<br/> monetize your followers & earn from your feed.</p>
                        </div>
                        <div class="banner-action wow fadeInUp" data-wow-delay=".3s" style="visibility:hidden">
                            ...
                            @else
                                <a href="{{ env('TWITTER_OAUTH_URL') }}" class="btn-common radius-50 btn-pink mr-20">Create Shop</a>
                            @endauth
                        </div>
                    </div>
                </div>
                    ...
                    <div class="ds-sm-none wow zoomIn">
                        <div class="pricing-table-single wow fadeIn" data-wow-delay=".3s">
                            ...
                            <div class="pricing-table-body">
                                ...
                                @else
                                <a href="{{ env('TWITTER_OAUTH_URL') }}" class="btn-common">Get Started</a>
                                @endauth
                            </div>
                        </div>
                    </div>
